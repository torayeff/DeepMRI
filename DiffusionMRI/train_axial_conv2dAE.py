...
from DiffusionMRI.AxialConv2dAE128 import ConvEncoder  # noqa: E402
from DiffusionMRI.AxialConv2dAE128 import ConvDecoder  # noqa: E402
...
trainset = Datasets.OrientationDataset(data_path + 'train/axial/', mu=mu, std=std, normalize=True)
...
prev_epoch = 1200
encoder_path = '/home/agajan/DeepMRI/DiffusionMRI/models/axial_conv2d_128_encoder_epoch_' + str(prev_epoch)
decoder_path = '/home/agajan/DeepMRI/DiffusionMRI/models/axial_conv2d_128_decoder_epoch_' + str(prev_epoch)
...
for epoch in range(1, num_epochs + 1):
    ...
    if epoch % 100 == 0:
        torch.save(encoder.state_dict(), "models/axial_conv2d_128_encoder_epoch_{}".format(epoch + prev_epoch))
        torch.save(decoder.state_dict(), "models/axial_conv2d_128_decoder_epoch_{}".format(epoch + prev_epoch))
