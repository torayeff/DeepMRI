...
for epoch in range(1, num_epochs + 1):
    ...
    if epoch % 100 == 0:
        torch.save(encoder.state_dict(), "models/axial_conv3d_encoder_epoch_{}".format(epoch + prev_epoch))
        torch.save(decoder.state_dict(), "models/axial_conv3d_decoder_epoch_{}".format(epoch + prev_epoch))
