...
shore_path = join(data_dir, subj_id, 'shore', 'shore_coefficients_radial_border_2.npz')
...
X_train, y_train, train_coords = ds_utils.create_dataset_from_data_mask(shore_coeffs,
                                                                        train_masks,
                                                                        labels=labels,
                                                                        multi_label=True)
...
test_masks = ml_masks
X_test, y_test, test_coords = ds_utils.create_dataset_from_data_mask(shore_coeffs,
                                                                     test_masks,
                                                                     labels=labels,
                                                                     multi_label=True)
