...
# load shore features
shore_path = join(data_dir, subj_id, 'learned_features', 'shore_features.npz')
...
X_train, y_train, train_coords = ds_utils.create_dataset_from_data_mask(shore_features,
                                                                        train_masks,
                                                                        labels=labels,
                                                                        multi_label=True)
...
test_masks = ml_masks
X_test, y_test, test_coords = ds_utils.create_dataset_from_data_mask(shore_features,
                                                                     test_masks,
                                                                     labels=labels,
                                                                     multi_label=True)
